...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "ECCFF"  # Playfab Title Id
        self.SecretKey: str = "AHB8OCJMJA6D4XXXRNO1I5FGO4KHXZWCP6IGKSN4RJOZYC7WCO"  # Playfab Secret Key
        self.ApiKey: str = "1184986378036963"  # App Api Key (Oculus/Graph API)
